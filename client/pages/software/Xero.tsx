...
export default function Xero() {
  const features = [
    {
      ...
      description: 'Access your financial data anytime, anywhere with secure cloud-based accounting.'
    },
    {
      icon: Zap,
      title: 'Real-Time Updates',
      description: 'Automatic bank feeds and real-time financial reporting for instant insights.'
    },
    {
      icon: BarChart3,
      title: 'Advanced Reporting',
      description: 'Comprehensive financial reports and dashboards for informed decision-making.'
    },
    {
      icon: Smartphone,
      title: 'Mobile Ready',
      description: 'Full mobile app functionality for managing finances on the go.'
    }
  ];
  ...
  const benefits = [
    'Reduce data entry by 80% with automated bank feeds',
    'Generate reports 10x faster than traditional methods',
    'Access real-time financial data from anywhere',
    'Seamless integration with 800+ business apps',
            ...
            <div className="space-y-8 animate-slide-in-left">
              <div className="space-y-4">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600">Xero</span> Accounting Services
                </h1>

                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed max-w-xl">
                  Expert Xero setup, training, and ongoing support to maximize your cloud accounting efficiency and business insights.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20 animate-fade-in-up">
            ...
            <p className="text-xl text-mavix-gray dark:text-gray-300 max-w-3xl mx-auto">
              Xero's powerful features combined with our expertise deliver exceptional accounting efficiency and insights.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slide-in-left">
              <h2 className="text-4xl md:text-5xl font-bold text-mavix-neutral-dark dark:text-white mb-8">
                Complete Xero Implementation
              </h2>
              <p className="text-xl text-mavix-gray dark:text-gray-300 mb-8 leading-relaxed">
                From initial setup to ongoing optimization, we provide comprehensive Xero services tailored to your business needs.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="animate-slide-in-right">
              ...
              <p className="text-xl text-mavix-gray dark:text-gray-300 mb-8 leading-relaxed">
                Experience the power of cloud accounting with measurable improvements to your business operations.
              </p>
              <div className="space-y-4">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Ready to Power Up with Xero?
            </h2>
            <p className="text-xl mb-10 text-gray-200">
              Let our Xero experts set up and optimize your cloud accounting system for maximum efficiency.
            </p>
